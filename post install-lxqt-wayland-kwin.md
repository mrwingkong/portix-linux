...
```
libnotify brightnessctl sxhkd iio-sensor-proxy qt6-tools xdg-desktop-portal xdg-desktop-portal-kde libarchive libstatgrab git wget unzip xz btrfs-progs ntfs-3g exfatprogs xfsprogs e2fsprogs f2fs-tools squashfs-tools sed mujs clang cmake ninja qemu-base libbsd
```
